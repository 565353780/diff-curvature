    ...
    * shillouette
    ...
    def forward(
        ...
        with torch.no_grad():
            ...
            gs_curvatures_vert = mg.get_gaussian_curvature_vertices_packed(meshes).view(
                -1, 1
            )  # V,1
            mean_curvature_vert = mg.get_mean_curvature_vertices_packed(meshes).view(
                -1, 1
            )  # V,1
